...
@section('contents')
    ...
    <form method="post" action="{{ route('shops.store') }}" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <label>起送金额</label>
            <input type="text" name="start_send" class="form-control" value="{{ old('shop_name') }}">
        </div>
        <div class="form-group">
            <label>配送费</label>
            <input type="text" name="send_cost" class="form-control" value="{{ old('shop_name') }}">
        </div>
        <div class="form-group">
            <label>店铺公告</label>
            <input type="text" name="notice" class="form-control" value="{{ old('shop_name') }}">
        </div>
        <div class="form-group">
            <label>优惠信息</label>
            <input type="text" name="discount" class="form-control" value="{{ old('shop_name') }}">
        </div>
